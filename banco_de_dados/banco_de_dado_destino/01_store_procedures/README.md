...
### O ETL utilizará as SP_delete*** para dasativar o objeto.

#### SP_DeletePasta
Desativar a tabela _"Pasta"_
A SP será utilizada para agregar as tarefas de auditoria e update "Desativação' da tabela _"Pasta"_. 
...
Script interno da SP _"SP_DeletePasta"_
```
